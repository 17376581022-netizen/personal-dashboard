...
Personal Dashboard 是一个无需安装的个人生活仪表盘。除自动天气、账号同步和音乐平台入口需要联网外，其他模块都可离线使用。它把天气、当天待办、习惯打卡、重要日期、快捷链接、音乐、项目进度、每日记录和月度回顾放在一个页面中。
...
- **音乐**：提供网易云音乐、QQ 音乐、酷狗音乐、酷我音乐和咪咕音乐入口。点击即可在新标签页打开对应平台播放；具体歌曲播放、版权和登录状态由音乐平台管理，浏览器不会绕过平台自动播放限制。
